...
import '../../../../componant/app_button.dart';
...
class _QuranViewState extends State<QuranView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const AppText(AppString.quranTitle),
        actions: [
          IconButton(
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      AppText(controller.errorMessage.value),
                      SizedBox(height: 16.h),
                      AppButton(
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 16.h),
                      const AppText(AppString.noSurahFound),
                    ],
                  ),
                );
              }
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 4.h),
                                AppText(
                                  '${surah.englishNameTranslation} • ${surah.numberOfAyahs} ${AppString.ayah}',
